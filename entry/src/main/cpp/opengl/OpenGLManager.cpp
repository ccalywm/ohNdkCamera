...
//         return;
//     }
//     LOGI("AddOutput called: window=%{public}p, size=%{public}dx%{public}d", window, width, height);
//    
...
//     glTexParameteri(GL_TEXTURE_EXTERNAL_OES, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
//     glBindTexture(GL_TEXTURE_EXTERNAL_OES, 0);
//     LOGI("OES texture created: %{public}u", oesTextureId_);
//     if (oesTextureId_ == 0){
//         return false;
//     }
//     return true;
